...
class Program
{
    static void Main(string[] args)
    {
        ...
        //List<int> Ns = new() { 30, 40 };
        //List<double> pks = new() { 0.8 };
        //List<double> pms = new() { 0.001 };
        //List<int> Ts = new() { 10,60 };

        Console.WriteLine("Starting...");
        var experimentsRunner = new ExperimentsRunner(Ns, pks, pms, Ts);

        string date = DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss");
        string logFilePath = $"experiments_results/{date}.csv";
        ...
        experimentsRunner.Run(new Progress<(ExperimentParameterSet, double)>(results =>
        {
